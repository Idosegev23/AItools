...
const aiTools = [
  ...
  // כלים חדשים שנוספו
  { category: 'מודל שפה גדול', name: 'Gemini', usage: 'מענה על שאלות, יצירת תמונות', link: 'https://gemini.google.com/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'מודל שפה גדול', name: 'DeepSeek', usage: 'מענה על שאלות, כתיבת קוד', link: 'https://www.deepseek.com/', price: 'חינם / בתשלום', difficulty: 'מתקדמים' },
  { category: 'מודל שפה גדול', name: 'Rytr', usage: 'כתיבה קצרה, תבניות, בדיקת פלגיאט', link: 'https://rytr.me/', price: 'בתשלום', difficulty: 'מתחילים' },
  { category: 'מודל שפה גדול', name: 'Grammarly', usage: 'תיקון דקדוק, התאמת טון', link: 'https://www.grammarly.com/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'וידאו', name: 'Synthesia', usage: 'יצירת סרטוני וידאו עם אוואטרים מדברים', link: 'https://www.synthesia.io/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'וידאו', name: 'Runway', usage: 'יצירת וידאו מטקסט, עריכת וידאו חכמה', link: 'https://runwayml.com/', price: 'חינם / בתשלום', difficulty: 'בינוני' },
  { category: 'ניהול זמן ופגישות', name: 'Fathom', usage: 'רישום פגישות, סיכומים והקלטות', link: 'https://www.fathom.video/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'ניהול זמן ופגישות', name: 'Nyota', usage: 'אוטומציה של רישום, ניהול משימות, תכנון', link: 'https://www.nyota.ai/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'אוטומציה', name: 'Asana', usage: 'ניהול משימות ופרויקטים עם אוטומציה', link: 'https://asana.com/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'אוטומציה', name: 'ClickUp', usage: 'ניהול פרויקטים עם תכונות בינה מלאכותית', link: 'https://clickup.com/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'אוטומציה', name: 'Shortwave', usage: 'סיכום ותרגום אימיילים', link: 'https://www.shortwave.com/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'תמונות / עריכה גרפית', name: 'Canva Magic Studio', usage: 'עיצוב גרפי עם כלי בינה מלאכותית', link: 'https://www.canva.com/magic/', price: 'חינם / בתשלום', difficulty: 'מתחילים' },
  { category: 'תמונות / עריכה גרפית', name: 'Looka', usage: 'עיצוב לוגו וחבילת מותג', link: 'https://looka.com/', price: 'בתשלום', difficulty: 'מתחילים' },
];
